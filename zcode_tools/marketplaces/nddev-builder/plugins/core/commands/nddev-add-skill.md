...
2. Create the skill directory (inside the active marketplace):
   - plugin-scoped: `zcode_tools/marketplaces/<marketplace>/plugins/<plugin>/skills/<name>/SKILL.md`
   - user-scoped: `zcode_tools/marketplaces/<marketplace>/skills/<name>/SKILL.md`
