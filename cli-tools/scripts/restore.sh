...
RESTORE_PATHS=(
  ...
  "v2/tasks-index.sqlite:v2/tasks-index.sqlite:replace"
  "v2/sessions:v2/sessions:replace"
  "v2/bot-config.json:v2/bot-config.json:replace"
  "v2/bot-state.json:v2/bot-state.json:replace"
  "v2/bot-state.v2.json:v2/bot-state.v2.json:replace"
